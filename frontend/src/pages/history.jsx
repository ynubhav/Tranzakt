...
import SpendingPie from "../components/charts";
...
export default function History() {
  ...
  useEffect(() => {
    try {
      axios
        .get(`${apiUrl}/account/transactions`, {
          headers: {
  ...
  useEffect(() => {
    ...
    transactions.map((data, index) => {
      if (data.credit) setearn((c) => c + data.amount);
      else setspent((c) => c + data.amount);
    });
      ...
      <div className="min-h-screen bg-black">
        ...
        <div className="mt-[64px] overflow-y-auto flex-1 p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 ">
            ...
            <div className="m-4 p-2 bg-gray-950 rounded-2xl border-2 border-indigo-400 shadow-sm shadow-white items-center justify-center">
